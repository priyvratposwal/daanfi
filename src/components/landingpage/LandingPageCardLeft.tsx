...
export default function LandingPageCardLeft({ 
  ...
  title,
  description,
  showDonateButton = true // Default to true for backward compatibility
      ...
      <div className="relative" style={{ width: `${calculatedWidth}px` }}>
        ...
        >
          ...
          <div className="relative z-10 p-6 pt-16">
            {/* Percentage */}
            <div className={`${showDonateButton ? 'mb-6' : ''}`}>
            ...
            {showDonateButton && (
              <Button 
                ...
                className="w-full bg-lime-50 hover:bg-lime-200 text-emerald-900 font-semibold py-6 rounded-2xl flex items-center justify-between text-base transition-all shadow-lg"
              >
